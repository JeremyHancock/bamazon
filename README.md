Bamazon is a command line interface app that is an Amazon-like storefront. The customer side of the app can take in orders from customers and deplete stock from the store's inventory.
